package com.nosoproject.nosowallet.ui.orderlist
...
import com.nosoproject.nosowallet.ui.addresslist.OrderRow
...
fun OrderHistory(modifier: Modifier, list:List<OrderObject>, onAction: (NosoAction, Any) -> Unit) {
    LazyColumn(
        ...
        if(list.isEmpty()){
            item {
                Text(text = "The local DB contains no orders, go send some noso!", modifier = Modifier
                    .padding(10.dp)
                    .fillMaxWidth(),
